...
export const goldStoreSeed: DevelopmentStoreSeed = {
  ...
  categories: [
    { name: "انگشتر طلا", slug: "gold-rings", description: "انگشترهای طلای زنانه و مردانه" },
    { name: "دستبند طلا", slug: "gold-bracelets", description: "دستبندهای زنجیری و مینیمال طلا" },
    { name: "گردنبند طلا", slug: "gold-necklaces", description: "گردنبند و زنجیرهای طلای ۱۸ عیار" },
    { name: "گوشواره طلا", slug: "gold-earrings", description: "گوشواره‌های میخی، حلقه‌ای و آویز" },
    { name: "مدال و آویز", slug: "gold-pendants", description: "مدال و آویزهای طلای مناسب هدیه" },
  ],
  products: [
    { sku: "DEV-GOLD-001", name: "انگشتر طلای مینیمال آوا", slug: "ava-minimal-gold-ring", categorySlug: "gold-rings", description: "انگشتر مینیمال طلای ۱۸ عیار مناسب استفاده روزمره.", stock: 5, weightGrams: "2.150", makingFeePercent: "8.5", featured: true },
    ...
    { sku: "DEV-GOLD-004", name: "دستبند طلای ونکلیف", slug: "van-cleef-gold-bracelet", categorySlug: "gold-bracelets", description: "دستبند طلای ظریف با فرم شبدر.", stock: 6, weightGrams: "2.780", makingFeePercent: "12.5", featured: true },
    ...
    { sku: "DEV-GOLD-006", name: "گردنبند طلای قلب", slug: "heart-gold-necklace", categorySlug: "gold-necklaces", description: "گردنبند طلای قلب مناسب هدیه.", stock: 5, weightGrams: "3.650", makingFeePercent: "10.5", featured: true },
