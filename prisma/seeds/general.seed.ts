...
export const generalStoreSeed: DevelopmentStoreSeed = {
  ...
  products: [
    ...
    { sku: "DEV-GEN-004", name: "ماگ حرارتی سرامیکی", slug: "ceramic-thermal-mug", categorySlug: "home-kitchen", brandSlug: "khaneara", description: "ماگ سرامیکی دوجداره مناسب نوشیدنی گرم.", stock: 24, fixedPrice: "8900000", discountPercent: "15", attributes: [{ attributeId: "home_material", values: ["سرامیک"] }, { attributeId: "home_usage", values: ["نوشیدنی گرم", "محل کار"] }], media: [{ key: "product-media-09", isCover: true }, { key: "product-media-06" }, { key: "product-media-03" }] },
    ...
    { sku: "DEV-GEN-006", name: "چراغ مطالعه تاشو", slug: "foldable-desk-lamp", categorySlug: "home-kitchen", brandSlug: "khaneara", description: "چراغ مطالعه LED با نور قابل تنظیم.", stock: 9, fixedPrice: "16500000", media: [{ key: "product-media-06", isCover: true }, { key: "product-media-03" }] },
    ...
    { sku: "DEV-GEN-008", name: "کیف دوشی مینیمال", slug: "minimal-shoulder-bag", categorySlug: "fashion-clothing", brandSlug: "styleline", description: "کیف دوشی سبک با فضای مناسب وسایل روزمره.", stock: 8, fixedPrice: "21900000", media: [{ key: "product-media-13", isCover: true }, { key: "product-media-07" }, { key: "product-media-02" }] },
    ...
    { sku: "DEV-GEN-010", name: "کوله پشتی طبیعت‌گردی", slug: "hiking-backpack", categorySlug: "sport-travel", brandSlug: "kouhpeyma", description: "کوله سبک طبیعت‌گردی با بندهای قابل تنظیم.", stock: 6, fixedPrice: "38500000", discountPercent: "8", media: [{ key: "product-media-10", isCover: true }, { key: "product-media-11" }, { key: "product-media-09" }] },
