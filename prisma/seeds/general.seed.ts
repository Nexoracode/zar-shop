import type { DevelopmentCategorySeed, DevelopmentMediaSeed, DevelopmentStoreSeed } from "./types";
...
export const generalStoreSeed: DevelopmentStoreSeed = {
  ...
  products: [
    ...
    { sku: "DEV-GEN-005", name: "ترازو آشپزخانه دیجیتال", slug: "digital-kitchen-scale", categorySlug: "home-kitchen", description: "ترازوی دقیق آشپزخانه با واحدهای اندازه‌گیری متنوع.", stock: 13, fixedPrice: "12700000", media: [{ key: "product-media-03", isCover: true }, { key: "product-media-06" }] },
    { sku: "DEV-GEN-006", name: "چراغ مطالعه تاشو", slug: "foldable-desk-lamp", categorySlug: "home-kitchen", description: "چراغ مطالعه LED با نور قابل تنظیم.", stock: 9, fixedPrice: "16500000", featured: true, media: [{ key: "product-media-06", isCover: true }, { key: "product-media-03" }] },
    { sku: "DEV-GEN-007", name: "هودی پنبه‌ای ساده", slug: "basic-cotton-hoodie", categorySlug: "fashion-clothing", description: "هودی پنبه‌ای راحت با دوخت مقاوم.", stock: 16, fixedPrice: "29800000", discountPercent: "20", media: [{ key: "product-media-01", isCover: true }, { key: "product-media-02" }, { key: "product-media-07" }, { key: "product-media-13" }] },
    { sku: "DEV-GEN-008", name: "کیف دوشی مینیمال", slug: "minimal-shoulder-bag", categorySlug: "fashion-clothing", description: "کیف دوشی سبک با فضای مناسب وسایل روزمره.", stock: 8, fixedPrice: "21900000", featured: true, media: [{ key: "product-media-13", isCover: true }, { key: "product-media-07" }, { key: "product-media-02" }] },
    { sku: "DEV-GEN-009", name: "قمقمه ورزشی یک لیتری", slug: "one-liter-sport-bottle", categorySlug: "sport-travel", description: "قمقمه ورزشی بدون نشتی و مناسب باشگاه.", stock: 21, fixedPrice: "7400000", media: [{ key: "product-media-11", isCover: true }, { key: "product-media-10" }, { key: "product-media-09" }] },
    { sku: "DEV-GEN-010", name: "کوله پشتی طبیعت‌گردی", slug: "hiking-backpack", categorySlug: "sport-travel", description: "کوله سبک طبیعت‌گردی با بندهای قابل تنظیم.", stock: 6, fixedPrice: "38500000", discountPercent: "8", featured: true, media: [{ key: "product-media-10", isCover: true }, { key: "product-media-11" }, { key: "product-media-09" }] },
    { sku: "DEV-GEN-011", name: "ماساژور دستی شارژی", slug: "rechargeable-hand-massager", categorySlug: "beauty-health", description: "ماساژور شارژی با چند سطح شدت.", stock: 10, fixedPrice: "27600000", media: [{ key: "product-media-04", isCover: true }, { key: "product-media-12" }] },
    { sku: "DEV-GEN-012", name: "ست مراقبت پوست روزانه", slug: "daily-skincare-set", categorySlug: "beauty-health", description: "ست آزمایشی مراقبت روزانه پوست شامل سه محصول.", stock: 14, fixedPrice: "34200000", discountPercent: "12", featured: true, media: [{ key: "product-media-12", isCover: true }, { key: "product-media-04" }] },
