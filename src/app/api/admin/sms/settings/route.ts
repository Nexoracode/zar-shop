...
import { communicationSettingsPatchSchema, getCommunicationSettings, saveCommunicationSettings } from "@/modules/communications/communication-settings";
...
export async function PATCH(request: Request) {
  try {
    ...
    const input = communicationSettingsPatchSchema.parse(await request.json()); await saveCommunicationSettings(input);
