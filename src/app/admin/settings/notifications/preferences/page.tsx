...
export default async function CommunicationPreferencesPage() { await requireAdminUser(); return <><AdminPageHeader eyebrow="پیامک و اعلان" title="تنظیمات پیامک و اعلان" description="کانال‌ها، رویدادها و متن پیام‌های سیستمی را مشخص کنید." backHref="/admin/settings/notifications" backLabel="بازگشت به پیامک و اعلان" /><CommunicationSettingsForm initialSettings={await getCommunicationSettings()} /></>; }
