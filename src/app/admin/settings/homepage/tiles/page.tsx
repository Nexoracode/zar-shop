...
import { BlueprintHomepageTileSettings } from "@/components/admin/blueprint/homepage-tile-settings";
...
export default async function HomepageTileSettingsPage() {
  ...
  return <>
    ...
    {brandSettings.adminTemplate === "BLUEPRINT" ? <BlueprintHomepageTileSettings initialSettings={settings} /> : <HomepageTileSettings initialSettings={settings} />}
  </>;
}
