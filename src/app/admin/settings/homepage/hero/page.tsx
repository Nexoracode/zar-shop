...
import { BlueprintHomepageHeroSettings } from "@/components/admin/blueprint/homepage-hero-settings";
...
export default async function HomepageHeroSettingsPage() {
  ...
  return <>
    ...
    {brandSettings.adminTemplate === "BLUEPRINT" ? <BlueprintHomepageHeroSettings initialSettings={settings} /> : <HomepageHeroSettings initialSettings={settings} />}
  </>;
}
