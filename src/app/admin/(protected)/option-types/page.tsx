...
export default async function OptionTypesPage() {
  ...
  return <BlueprintOptionTypesView types={items} colors={colors} initialHiddenColumns={initialHiddenColumns} />;
}
