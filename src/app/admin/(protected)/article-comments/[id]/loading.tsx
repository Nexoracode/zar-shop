...
// Mirrors the article comment detail page: the vote metrics, then the comment with its replies beside the
// moderation card.
export default function ArticleCommentDetailLoading() {
  return (
    <div className="animate-pulse" aria-hidden>
      <BpPageHeaderSkeleton withBack withAction />
      <BpMetricCardsSkeleton preset="detailPair" />
