...
export default async function SmsPatternsPage() {
  ...
  const initialHiddenColumns = await readHiddenColumns("smsPatterns");
  ...
  return <>
    ...
    ) : <BlueprintSmsPatternList initialPatterns={patterns} initialHiddenColumns={initialHiddenColumns} />}
  </>;
}
