...
export type ProductRow = Prisma.ProductGetPayload<{ include: { category: true; media: { include: { media: true } }; _count: { select: { variants: true; orderItems: true } }; optionTypes: { select: { type: { select: { name: true } } } } } }>;
