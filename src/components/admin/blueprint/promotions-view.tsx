                ...
                <article key={item.id} className="flex flex-col gap-2.5 border-b border-[var(--bp-row-line)] p-4 last:border-b-0">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <Link href={`/admin/promotions/${item.id}/edit`} aria-label={`ویرایش ${item.title}`} className="bp-btn bp-btn-secondary bp-btn-icon bp-btn-sm"><Pencil size={13} /></Link>
                    ...
                    <AdminBulkTr key={item.id} id={item.id}>
                      ...
                      <BpTd>
                        <div className="flex items-center justify-center gap-1">
                          ...
                          <Link href={`/admin/promotions/${item.id}/edit`} aria-label={`ویرایش ${item.title}`} title="ویرایش" className="bp-btn bp-btn-secondary bp-btn-icon bp-btn-sm"><Pencil size={14} /></Link>
