  ...
  const allGroups: Array<{ id: string; title: string; description: string; items: SettingsItem[] }> = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/admin/settings/card-to-card", title: "کارت‌به‌کارت", description: "کارت مقصد و فعال‌سازی پرداخت کارت‌به‌کارت", icon: ArrowLeftRight },
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/admin/settings/seo", title: "SEO حرفه‌ای", description: "ایندکس‌پذیری، سایت‌مپ و ریدایرکت‌ها", icon: SearchCheck },
