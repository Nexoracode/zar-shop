...
export function BlueprintDashboardView({ isFullAdmin, activeProducts, customers, actionableOrders, revenueTotal, lowStockThreshold, recentOrders, lowStockProducts }: AdminDashboardData) {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className={`grid grid-cols-1 gap-4 sm:grid-cols-2 ${isFullAdmin ? "xl:grid-cols-4" : "xl:grid-cols-2"}`}>
      ...
      <div className={`grid gap-6 ${isFullAdmin ? "xl:grid-cols-[minmax(0,1.55fr)_minmax(280px,0.75fr)]" : "grid-cols-1"}`}>
        <Panel>
