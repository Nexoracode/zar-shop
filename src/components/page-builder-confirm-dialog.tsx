  ...
  return (
    ...
    <Modal.Backdrop isOpen onOpenChange={(next) => { if (!next) onClose(); }} variant="blur" className="z-[150]">
      <Modal.Container size="sm" placement="center">
        <Modal.Dialog data-page-builder-ui aria-label={title} dir="rtl" className="mx-4 max-w-md bg-[var(--surface)] text-right">
          ...
          <Modal.Body className="p-5 text-sm leading-7 text-[var(--muted)]">{children}</Modal.Body>
