  ...
  return (
    <div className="grid gap-3">
      {options.length > 0 && <div className="grid gap-4">
        ...
        {!selectedWeightValue && selectedPriceValue && <div className="flex items-center justify-between rounded-lg border border-[#dfd3bc] bg-white px-3 py-2 text-xs"><span className="text-[#747982]">قیمت تنوع انتخاب‌شده</span><strong className="text-[#17233b]">{formatMoney(selectedPriceValue.price!)}</strong></div>}
      </div>}
      <Button
        onPress={() => void add()}
