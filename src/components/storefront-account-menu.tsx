...
import { ChevronDown, ChevronLeft, Heart, LogOut, MapPin, MessageCircle, ShoppingBag, UserRound, Wallet } from "lucide-react";
...
export function StorefrontAccountMenu({ user, className = "" }: { user: AccountUser | null; className?: string }) {
  ...
  const items = [
    ...
    { href: "/account/reviews", label: "دیدگاه‌ها", icon: MessageCircle },
  ];
