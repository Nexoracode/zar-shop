...
export function PendingOrderCartNotice({ orderId, orderNumber, total, expiresAt, paymentProvider, warningMinutes, expirationAction }: { orderId: string; orderNumber: string; total: string; expiresAt: string | null; paymentProvider: string | null; warningMinutes: number; expirationAction: "EXPIRE" | "CANCEL" | "NOTIFY" }) {
