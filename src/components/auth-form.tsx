...
export function AuthForm({ mode }: { mode: "login" | "register" }) {
  ...
  return <form className="form" onSubmit={submit}>
    {mode==="register"&&<div className="form-row"><div className="field"><label>نام</label><input name="firstName" required minLength={2}/></div><div className="field"><label>نام خانوادگی</label><input name="lastName" required minLength={2}/></div></div>}
    <div className="field"><label>ایمیل</label><input name="email" type="email" dir="ltr" required/></div>
    {mode==="register"&&<div className="field"><label>شماره موبایل</label><input name="phone" inputMode="tel" dir="ltr" placeholder="09123456789" required/></div>}
    <div className="field"><label>رمز عبور</label><input name="password" type="password" dir="ltr" minLength={8} required/></div>
