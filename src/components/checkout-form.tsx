...
type Quote = { subtotal: number; productDiscount: number; merchandiseAmount: number; promotionDiscount: number; shipping: number; shippingDiscount: number; shippingFree?: FreeShippingReason | null; total: number; walletBalance: number; walletApplied: number; payable: number; applications: Array<{ title: string; code: string | null; discountAmount: number; shippingDiscount: number }> };
