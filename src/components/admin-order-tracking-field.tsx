  ...
  return (
    <form onSubmit={submit} className="grid gap-2 rounded-xl bg-slate-50 px-4 py-3">
      ...
      <div className="flex items-center gap-2">
        <Input value={value} onChange={(event) => setValue(event.target.value)} dir="ltr" placeholder="در انتظار ثبت فروشگاه" disabled={saving} fullWidth variant="secondary" className={`${adminFieldClass} !min-h-9 h-9 text-xs`} />
