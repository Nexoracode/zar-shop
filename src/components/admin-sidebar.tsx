...
export function AdminSidebar({ user }: Props) {
  ...
  return (
    <>
      ...
      <aside className="admin-sidebar hidden self-start overflow-hidden rounded-[24px] bg-[var(--accent)] p-4 text-[var(--accent-foreground)] shadow-[0_24px_70px_rgba(16,35,62,0.18)] lg:sticky lg:top-5 lg:flex lg:h-[calc(100dvh-2.5rem)] lg:min-h-0 lg:flex-col">
