...
export function AdminSidebar({ user }: Props) {
  ...
  return (
    <>
      ...
      <aside className="hidden h-[calc(100vh-180px)] min-h-[520px] self-start overflow-hidden rounded-[24px] bg-[#172b4d] p-4 text-white shadow-[0_24px_70px_rgba(16,35,62,0.18)] lg:flex lg:flex-col">
