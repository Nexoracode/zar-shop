...
export function CartItemCard({ id, name, slug, imageUrl, imageAlt, maxQuantity, optionSummary, weight, unitPrice, originalUnitPrice, discountEndsAt, currency, preparationDays }: Props) {
  ...
  return (
    <article className="grid gap-4 border-b border-[var(--border)] p-4 last:border-b-0 sm:grid-cols-[150px_minmax(0,1fr)] sm:p-5">
      ...
      <div className="min-w-0">
        {discountEndsAt && originalUnitPrice !== null && originalUnitPrice > unitPrice && <div className="mb-3"><CartFlashSalePill endsAt={discountEndsAt} /></div>}
