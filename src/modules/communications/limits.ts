...
export const smsProviderFieldLimits = { apiKey: 500, username: 191, password: 500, senderNumber: 20, otpPatternCode: 100, otpVariableName: smsPatternFieldLimits.variableName } as const;
