...
import {
  BadgePercent, Boxes, ChartNoAxesCombined, FolderTree, Images, ListChecks, ListTree, Mail,
  MessageSquareText, PackageCheck, Palette, ScrollText, Settings, SlidersHorizontal, Users,
} from "lucide-react";
