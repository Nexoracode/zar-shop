...
const createEntries: AdminSearchEntry[] = [
  ...
  { id: "create-order", title: "ثبت سفارش دستی", description: "ایجاد سفارش تازه برای مشتری", href: "/admin/orders/new", group: "سفارش‌ها و پرداخت", icon: Plus, keywords: [...addSynonyms, "سفارش", "فاکتور دستی"], permission: "orders:manage" },
  { id: "create-promotion", title: "افزودن پروموشن", description: "ثبت کد تخفیف یا کمپین تازه", href: "/admin/promotions/new", group: "سفارش‌ها و پرداخت", icon: Plus, keywords: [...addSynonyms, "تخفیف", "کد تخفیف", "کمپین"], permission: "orders:manage" },
  { id: "create-shipping-method", title: "افزودن روش ارسال", description: "ثبت روش ارسال تازه", href: "/admin/shipping-methods/new", group: "ارسال و بسته‌بندی", icon: Plus, keywords: [...addSynonyms, "ارسال", "پست", "باربری"], permission: "orders:manage" },
  { id: "create-user", title: "افزودن کاربر", description: "ثبت حساب کاربری تازه", href: "/admin/users/new", group: "مشتریان و بازخورد", icon: Plus, keywords: [...addSynonyms, "کاربر", "حساب", "مدیر جدید"], permission: "users:manage" },
