...
const actionLabels: Record<string, string> = {
  ...
  PACKAGING_BOX_CREATE: "ثبت جعبه بسته‌بندی",
  PACKAGING_BOX_UPDATE: "ویرایش جعبه بسته‌بندی",
  PACKAGING_BOX_DELETE: "حذف جعبه بسته‌بندی",
  ...
  CARD_TO_CARD_SETTINGS_UPDATE: "ویرایش تنظیمات کارت‌به‌کارت",
  CARD_TO_CARD_PAYMENT_APPROVED: "تأیید پرداخت کارت‌به‌کارت",
  CARD_TO_CARD_PAYMENT_REJECTED: "رد پرداخت کارت‌به‌کارت",
  ...
  SMS_PATTERN_DELETE: "حذف پترن پیامک",
...
const entityLabels: Record<string, string> = {
  ...
  packagingBoxes: "جعبه‌های بسته‌بندی",
